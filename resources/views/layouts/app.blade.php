    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                ...
                <a href="tg://resolve?domain=Buonumare_krd">
        ...
        function cart_update(_this, qt, md){
            $.ajax({
                ...
                if(data.success) {
                    ...
                    _this.parents('tr').find('.product__qt_text').text(qt);
                    var total = $('#product__total');
                    if(md == '+')
                        total.text(parseInt(total.text()) + parseInt(cost));
                    else
                        total.text(parseInt(total.text()) - parseInt(cost));
                }
            });
